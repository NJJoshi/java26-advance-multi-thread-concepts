...
*/
public class ScopedValuePropagationDemo {
    private static final Logger log = LoggerFactory.getLogger(ScopedValuePropagationDemo.class);
    ...
    private static void orderService() {
        ...
        try(var scope = StructuredTaskScope.open(StructuredTaskScope.Joiner.allSuccessfulOrThrow())){
            scope.fork(ScopedValuePropagationDemo::callProductService);
            scope.fork(ScopedValuePropagationDemo::callInventoryService);
