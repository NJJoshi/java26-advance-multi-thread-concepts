...
public class AuthenticationService {
    ...
    private static final Map<Integer, UserRole> USER_ROLES =
            Map.of(1, UserRole.ADMIN, 2, UserRole.EDITOR, 3, UserRole.VIEWER);
    ...
    public static void runAsAdmin(Runnable runnable) {
        var securityContext = SecurityContextHolder.getScopedValue().orElseThrow(() -> new SecurityException("User must login"));
